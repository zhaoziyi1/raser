...
cmake -DCMAKE_INSTALL_PREFIX=$HOME/geant4/install -DGEANT4_INSTALL_DATA=ON -DGEANT4_INSTALL_DATADIR=$HOME/geant4/data -DGEANT4_BUILD_TLS_MODEL=global-dynamic -DGEANT4_USE_PYTHON=ON ../src/geant4.10.07.p02  
make -j24 
make install 
